...
export default ({ config }: ConfigContext): ExpoConfig => ({
  ...
  extra: {
    ...
    environments: {
      prod: {
        title: 'Production',
        apiUrl: 'https://backend.saveful.devsomeware.com',
        webUrl: 'https://backend.saveful.devsomeware.com',
        socketUrl: 'wss://backend.saveful.devsomeware.com/socket/app',
      ...
      local: {
        android: {
          ...
          socketUrl: process.env.SOCKET_URL ?? 'wss://192.168.0.192:3000/socket/app',
        },
        ios: {
          title: 'Local (iOS)',
          ...
          socketUrl: process.env.SOCKET_URL ?? 'wss://backend.saveful.devsomeware.com/socket/app',
        },
      },
    },
